...
void GamePickerActivity::openSelectedGame() {
  auto onReturnToPicker = [this](const ActivityResult&) {
    ignoreBackUntilMs = millis() + 250;
    requestUpdate();
  };
  ...
  switch (selectorIndex) {
    case 0:
      ...
      break;
    case 1:
      startActivityForResult(std::make_unique<SolitaireActivity>(renderer, mappedInput, [] { activityManager.popActivity(); }),
                             onReturnToPicker);
      break;
    case 2:
