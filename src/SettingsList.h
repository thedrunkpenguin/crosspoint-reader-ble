...
inline std::vector<SettingInfo> getSettingsList(const SdCardFontRegistry* registry = nullptr) {
  static const std::vector<SettingInfo> baseList = [] {
    std::vector<StrId> themeOptions = {StrId::STR_THEME_CLASSIC, StrId::STR_THEME_LYRA, StrId::STR_THEME_LYRA_EXTENDED,
                                       StrId::STR_THEME_ROUNDEDRAFF};
    if constexpr (CrossPointSettings::cardsThemeEnabled) {
      themeOptions.push_back(StrId::STR_THEME_CARDS);
    }
    ...
    std::vector<SettingInfo> v = {
        ...
        SettingInfo::Enum(StrId::STR_UI_THEME, &CrossPointSettings::uiTheme, themeOptions, "uiTheme",
              StrId::STR_CAT_DISPLAY),
