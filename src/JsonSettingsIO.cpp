...
bool JsonSettingsIO::loadSettings(CrossPointSettings& s, const char* json, bool* needsResave) {
  ...
  s.removeReadBooksFromRecents = doc["removeReadBooksFromRecents"] | s.removeReadBooksFromRecents;
  s.moveFinishedToReadFolder = doc["moveFinishedToReadFolder"] | s.moveFinishedToReadFolder;
